    ...
    <nav className='h-16 flex flex-col justify-center px-12 bg-cyan-600 text-cyan-300 font-bold'>
        <ul className='flex justify-between items-center uppercase'>
            ...
            <div className='flex gap-4'>
                ...
                <li className='relative'><span className='after:content-[""] after:absolute after:bottom-[-0.2rem] after:left-0 after:bg-cyan-950 after:w-full after:h-1 cursor-pointer'>contacto</span></li>
